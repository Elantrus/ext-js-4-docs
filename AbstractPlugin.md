...
Creates clone of the plugin.
ParametersoverrideCfg : Object (optional)Additional config for the derived plugin.
...
Returns the component to which this plugin is attached.
ReturnsExt.ComponentOwner component.
...
Parametersclient : Ext.ComponentThe client Component which owns this plugin.
...
Sets the component to which this plugin is attached.
Parameterscmp : Ext.ComponentOwner component.
