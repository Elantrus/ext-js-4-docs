...
Creates new Shadow.
Parametersconfig : Object (optional)Config object.
...
Returns the shadow size on each side of the element in standard CSS order: top, right, bottom, left;
ReturnsNumber[]Top, right, bottom and left shadow size.
...
Parametersleft : NumberThe target element left position
...
Sets the opacity of the shadow
Parametersopacity : NumberThe opacity
...
Adjust the z-index of this shadow
Parameterszindex : NumberThe new z-index
...
Displays the shadow under the target element
ParameterstargetEl : String/HTMLElement/Ext.ElementThe id or element under which the shadow should display
