...
ReturnsExt.Element/Ext.Componentthe focus holding element or Component.
...
Overrides: Ext.panel.Panel.initDraggable
...
Parametersanimate : Boolean`true` to animate this Window to full size.
...
Overrides: Ext.AbstractComponent.onFocus
...
Parametersicon : StringA CSS classname specifying the icon's background image url, or empty string to clear the icon
...
Parametersconfig : ObjectThe following config options are supported:
animateTarget : String/Ext.dom.ElementAn id or Element from which the message box should animate as it opens and closes.
...
Set button text according to current buttonText property object
ReturnsNumberThe buttons bitwise flag based upon the button IDs specified in the buttonText property.
...
Parametersvalue : Number (optional)Any number between 0 and 1 (e.g., .5)
Defaults to: `0`
...
Parametersmsg : StringThe message box body text
...
Fires after the window has been visually activated via setActive.
Parametersthis : Ext.window.Window
...
The background-color of the MessageBox body
Defaults to: `$window-body-background-color`
...
The border-color of the MessageBox body
Defaults to: `$window-body-border-color`
...
The border-style of the MessageBox body
Defaults to: `$window-body-border-style`
...
The border-radius of Windows
Defaults to: `$panel-frame-border-radius`
...
The opacity of ghost Windows while dragging
Defaults to: `$panel-ghost-opacity`
...
The color of the Window Header glyph icon
Defaults to: `$window-header-color`
...
The padding of Window Headers
Defaults to: `$panel-frame-header-padding`
...
The padding of Windows
Defaults to: `$panel-frame-padding`
...
the wrap border is controlled by the border config. Only applicable when
`$window-include-border-management-rules` is `true`.
Defaults to: `$window-border-color`
