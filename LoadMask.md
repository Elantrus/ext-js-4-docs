...
Defaults to: `Ext.baseCSSPrefix + 'mask-msg'`Overrides: Ext.AbstractComponent.baseCls
...
not be set.
Defaults to: `{shadow: 'frame'}`Overrides: Ext.Component.floating
...
Defaults to: `['<div id="{id}-msgEl" class="{[values.$comp.msgCls]} ', Ext.baseCSSPrefix, 'mask-msg-inner{childElCls}">', '<div id="{id}-msgTextEl" class="', Ext.baseCSSPrefix, 'mask-msg-text', '{childElCls}"></div>', '</div>']`Overrides: Ext.AbstractComponent.renderTpl
...
Creates new LoadMask.
Parametersconfig : Object (optional)The config object.
...
Changes the data store bound to this LoadMask.
Parametersstore : Ext.data.StoreThe store to bind to this LoadMask
...
Parametersstore : Ext.data.AbstractStoreThe store to bind to
...
Gets the current store instance.
ReturnsExt.data.AbstractStoreThe store, null if one does not exist.
...
Gets the listeners to bind to a new store.
Parametersstore : Ext.data.StoreThe Store which is being bound to for which a listeners object should be returned.
...
Template method, it is called when a new store is bound
to the current instance.
Parametersstore : Ext.data.AbstractStoreThe store being bound
...
Template method, it is called when an existing store is unbound
from the current instance.
Parametersstore : Ext.data.AbstractStoreThe store being unbound
...
in a subclass to provide any more complicated handling.
Parametersstore : Ext.data.AbstractStoreThe store to unbind from
