...
Parametersvalue : Number (optional)A floating point value between 0 and 1 (e.g., .5)
Defaults to: `0`
...
Parameterstext : String (optional)The string to display in the progress text element
Defaults to: `''`
...
Parametersconfig : Object (optional)Configuration options
duration : NumberThe length of time in milliseconds that the progress bar should
...
Fires after each update interval
Parametersthis : Ext.ProgressBar
