...
Defaults to: `Ext.baseCSSPrefix + 'tool'`Overrides: Ext.AbstractComponent.baseCls
...
A function to execute when the tool is clicked.
        Available since: 4.2
Parametersowner : Ext.ComponentThe logical owner of the tool. In a typical
...
CSS class to add when the Component is disabled.
Defaults to: `Ext.baseCSSPrefix + 'tool-disabled'`Overrides: Ext.AbstractComponent.disabledCls
...
Defaults to: `15`Overrides: Ext.AbstractComponent.height
...
Defaults to: `['<img role="presentation" id="{id}-toolEl" src="{blank}" class="{baseCls}-img {baseCls}-{type}' + '{childElCls}" role="presentation"/>']`Overrides: Ext.AbstractComponent.renderTpl
...
Defaults to: `Ext.baseCSSPrefix + 'tool-over'`
...
Defaults to: `Ext.baseCSSPrefix + 'tool-pressed'`
...
The width of this component in pixels.
Defaults to: `15`Overrides: Ext.AbstractComponent.width
...
Defaults to: `{close: 1, collapse: 1, down: 1, expand: 1, gear: 1, help: 1, left: 1, maximize: 1, minimize: 1, minus: 1, next: 1, pin: 1, plus: 1, prev: 1, print: 1, refresh: 1, restore: 1, right: 1, save: 1, search: 1, toggle: 1, unpin: 1, up: 1}`
...
Defaults to: `['toolEl']`Overrides: Ext.util.ElementContainer.childEls
...
Parameterstype : StringThe new type. See the type config.
...
### $tool-include-hover-icons

**Tipo:** boolean

True to change the background-position of the Tool on hover. ...
