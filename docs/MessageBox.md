...
Override. Windows are always simple draggable, they do not use Ext.Panel.DDs The dd property in a Window is always a ComponentDragger Overrides: Ext.panel.Panel.initDraggable
...
Overrides: Ext.panel.Panel.initResizable
...
**Parameters:** animate : Boolean`true` to animate this Window to full size.
...
Overrides: Ext.window.Window.onEsc
...
Called when a Component's focusEl receives focus. If there is a valid default focus Component to jump to, focus that, otherwise continue as usual, focus this Component. Overrides: Ext.AbstractComponent.onFocus
...
Displays a message box with a progress bar. You are responsible for updating the progress bar as needed via updateProgress and closing the message box when the process is complete.
...
**Parameters:** icon : StringA CSS classname specifying the icon's background image url, or empty string to clear the icon
...
**Parameters:** config : ObjectThe following config options are supported: animateTarget : String/Ext.dom.ElementAn id or Element from which the message box should animate as it opens and closes.
...
**Returns:** NumberThe buttons bitwise flag based upon the button IDs specified in the buttonText property.
...
**Parameters:** value : Number (optional)Any number between 0 and 1 (e.g., .5) Defaults to: `0`
...
**Parameters:** msg : StringThe message box body text
...
**Parameters:** this : Ext.window.Window
...
### $include-window-default-ui

**Type:** boolean

True to include the "default" window UI ...

True to include the "default" window UI Defaults to: `$include-default-uis`
...
The background-color of the MessageBox body Defaults to: `$window-body-background-color`
...
The border-color of the MessageBox body Defaults to: `$window-body-border-color`
...
The border-style of the MessageBox body Defaults to: `$window-body-border-style`
...
The border-width of the MessageBox body Defaults to: `0`


### $messagebox-icon-background-position

**Type:** list

The background-position of the MessageBox icon ...

The background-position of the MessageBox icon Defaults to: `top left`
...
True to force the window header to have a border on the side facing the window body. Overrides dock layout's border management border removal rules.
...
The background-color of Windows Defaults to: `#fff`
...
The base color of Windows Defaults to: `$base-color`
...
The body background-color of Windows Defaults to: `#fff`


### $window-body-border-color

**Type:** color

The body border-color of Windows ...

The body border-color of Windows Defaults to: `$window-base-color`


### $window-body-border-style

**Type:** string

The body border-style of Windows ...

The body border-style of Windows Defaults to: `solid`


### $window-body-border-width

**Type:** number

The body border-width of Windows ...

The body border-width of Windows Defaults to: `1px`
...
The body text color of Windows Defaults to: `#000`
...
The border-color of Windows Defaults to: `$window-base-color`
...
The border-radius of Windows Defaults to: `$panel-frame-border-radius`
...
The border-width of Windows Defaults to: `1px`


### $window-ghost-opacity

**Type:** number

The opacity of ghost Windows while dragging ...

The opacity of ghost Windows while dragging Defaults to: `$panel-ghost-opacity`
...
The background-color of Window Headers Defaults to: `$window-base-color`


### $window-header-border-width

**Type:** number

The border-width of Window Headers ...

The border-width of Window Headers Defaults to: `1px`
...
The text color of Window Headers Defaults to: `$panel-header-color`


### $window-header-font-family

**Type:** string

The font-family of Window Headers ...

The font-family of Window Headers Defaults to: `$panel-header-font-family`
...
The font-size of Window Headers Defaults to: `$panel-header-font-size`


### $window-header-font-weight

**Type:** string

The font-weight of Window Headers ...

The font-weight of Window Headers Defaults to: `$panel-header-font-weight`


### $window-header-glyph-color

**Type:** color

The color of the Window Header glyph icon ...

The color of the Window Header glyph icon Defaults to: `$window-header-color`


### $window-header-glyph-opacity

**Type:** number

The opacity of the Window Header glyph icon ...

The opacity of the Window Header glyph icon Defaults to: `$panel-header-glyph-opacity`


### $window-header-icon-background-position

**Type:** list

The background-position of the Window Header icon ...

The background-position of the Window Header icon Defaults to: `$panel-header-icon-background-position`


### $window-header-icon-height

**Type:** number

The height of the Window Header icon ...

The height of the Window Header icon Defaults to: `$panel-header-icon-height`


### $window-header-icon-spacing

**Type:** number

The space between the Window Header icon and text ...

The space between the Window Header icon and text Defaults to: `$panel-header-icon-spacing`


### $window-header-icon-width

**Type:** number

The width of the Window Header icon ...

The width of the Window Header icon Defaults to: `$panel-header-icon-width`


### $window-header-inner-border-color

**Type:** color

The inner border-color of Window Headers ...

The inner border-color of Window Headers Defaults to: `#fff`


### $window-header-inner-border-width

**Type:** number

The inner border-width of Window Headers ...

The inner border-width of Window Headers Defaults to: `0`
...
The line-height of Window Headers Defaults to: `$panel-header-line-height`
...
The padding of Window Headers Defaults to: `$panel-frame-header-padding`


### $window-header-text-padding

**Type:** number/list

The padding of the Window Header's text element ...

The padding of the Window Header's text element Defaults to: `$panel-header-text-padding`


### $window-header-text-transform

**Type:** string

The text-transform of Window Headers ...

The text-transform of Window Headers Defaults to: `$panel-header-text-transform`


### $window-include-border-management-rules
...
The inner border-color of Windows Defaults to: `#fff`
...
The inner border-width of Windows Defaults to: `0`
...
The padding of Windows Defaults to: `$panel-frame-padding`


### $window-tool-background-image

**Type:** string

The background sprite to use for Window Tools ...

The background sprite to use for Window Tools Defaults to: `'tools/tool-sprites'`
...
The space between the Window Tools ...

The space between the Window Tools Defaults to: `$panel-tool-spacing`


### $window-wrap-border-color

**Type:** color

The color to apply to the border that wraps the body and docked items. ...

The color to apply to the border that wraps the body and docked items. The presence of the wrap border is controlled by the border config. Only applicable when `$window-include-border-management-rules` is `true`. Defaults to: `$window-border-color`


### $window-wrap-border-width

**Type:** number

The width to apply to the border that wraps the body and docked items. ...

The width to apply to the border that wraps the body and docked items. The presence of the wrap border is controlled by the border config. Only applicable when `$window-include-border-management-rules` is `true`. Defaults to: `1px`
...
Creates a visual theme for a Window $ui-label : stringThe name of the UI being created. Can not included spaces or special punctuation (used in CSS class names).
