...
**Parameters:** this : Ext.ProgressBar
...
True to include the "default" ProgressBar UI Defaults to: `$include-default-uis`
...
The background-color of the ProgressBar Defaults to: `$base-color`
...
The background-color of the ProgressBar's moving element Defaults to: `$base-color`
...
The background-gradient of the ProgressBar's moving element. ...

The background-gradient of the ProgressBar's moving element. Can be either the name of a predefined gradient or a list of color stops. Used as the `$type` parameter for Global_CSS.background-gradient. Defaults to: `null`
...
The border-color of the ProgressBar Defaults to: `$base-color`
...
The border-radius of the ProgressBar Defaults to: `0`
...
The border-width of the ProgressBar Defaults to: `1px`
...
The height of the ProgressBar Defaults to: `20px`
...
The color of the ProgressBar's text when the ProgressBar's 'moving element is not under it Defaults to: `#000`
...
The color of the ProgressBar's text when in front of the ProgressBar's moving element Defaults to: `#fff`
...
The font-size of the ProgressBar's text Defaults to: `$font-size`
...
The font-weight of the ProgressBar's text Defaults to: `bold`


### $progress-text-text-align

**Type:** string

The text-align of the ProgressBar's text ...

The text-align of the ProgressBar's text Defaults to: `center`
...
Creates a visual theme for an Ext.ProgressBar $ui-label : stringThe name of the UI being created. Can not included spaces or special punctuation (used in CSS class names).
