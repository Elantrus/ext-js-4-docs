...
This class implements the global event domain. This domain represents event fired from Ext.globalEvents Observable instance. No selectors are supported for this domain.
...
This method adds listeners on behalf of a controller. Since Global domain does not support selectors, we skip this layer and just accept an object keyed by events. For example:

**Parameters:** listeners : ObjectConfig object containing listeners.
