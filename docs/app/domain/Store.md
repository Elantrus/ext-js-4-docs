...
This class implements the data store event domain. All classes extending from Ext.data.AbstractStore are included in this domain. The selectors are simply store id's or the wildcard "*" to match any store.
...
Name of the identifier property for this event domain. Defaults to: `'storeId'` Overrides: Ext.app.EventDomain.idProperty
