...
This class implements the controller event domain. All classes extending from Ext.app.Controller are included in this domain. The selectors are simply id's or the wildcard "*" to match any controller.
...
**Returns:** Ext.app.domain.Controller
