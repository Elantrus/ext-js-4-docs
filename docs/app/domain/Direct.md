...
This class implements the Ext.Direct event domain. All classes extending from Ext.direct.Provider are included in this domain. The selectors are simply provider id's or the wildcard "*" to match any provider.
...
Name of the identifier property for this event domain. Defaults to: `'id'` Overrides: Ext.app.EventDomain.idProperty
