...
**Parameters:** store : Ext.data.StoreThe Store which is being bound to for which a listeners object should be returned.
...
### $loadmask-background-color

**Type:** color

The background-color of the LoadMask ...

The background-color of the LoadMask Defaults to: `#ccc`
...
The type of cursor to dislay when the cursor is over the LoadMask Defaults to: `null`
...
The background-color of the LoadMask's message element Defaults to: `$base-color`
...
The background-gradient of the LoadMask's message element. ...

The background-gradient of the LoadMask's message element. Can be either the name of a predefined gradient or a list of color stops. Used as the `$type` parameter for Global_CSS.background-gradient. Defaults to: `null`


### $loadmask-msg-border-color

**Type:** color

The border-color of the LoadMask's message element ...

The border-color of the LoadMask's message element Defaults to: `$base-color`


### $loadmask-msg-border-radius

**Type:** number

The border-radius of the message element ...

The border-radius of the message element Defaults to: `0`


### $loadmask-msg-border-style

**Type:** string

The border-style of the LoadMask's message element ...

The border-style of the LoadMask's message element Defaults to: `solid`


### $loadmask-msg-border-width

**Type:** number

The border-width of the LoadMask's message element ...

The border-width of the LoadMask's message element Defaults to: `1px`


### $loadmask-msg-inner-background-color

**Type:** color

The background-color of the message inner element ...

The background-color of the message inner element Defaults to: `#eee`


### $loadmask-msg-inner-border-color

**Type:** color

The border-color of the message inner element ...

The border-color of the message inner element Defaults to: `$base-color`


### $loadmask-msg-inner-border-style

**Type:** string

The border-style of the message inner element ...

The border-style of the message inner element Defaults to: `solid`


### $loadmask-msg-inner-border-width

**Type:** number

The border-width of the message inner element ...

The border-width of the message inner element Defaults to: `1px`


### $loadmask-msg-inner-color

**Type:** color

The text color of the message inner element ...

The text color of the message inner element Defaults to: `#222`


### $loadmask-msg-inner-font-family

**Type:** string

The font-family of the message inner element ...

The font-family of the message inner element Defaults to: `$font-family`


### $loadmask-msg-inner-font-size

**Type:** number

The font-size of the message inner element ...

The font-size of the message inner element Defaults to: `$font-size`
...
The font-weight of the message inner element Defaults to: `normal`


### $loadmask-msg-inner-icon

**Type:** string

The icon to display in the message inner element ...

The icon to display in the message inner element Defaults to: `'loadmask/loading'`


### $loadmask-msg-inner-icon-position

**Type:** list

The background-position of the icon ...

The background-position of the icon Defaults to: `0 center`


### $loadmask-msg-inner-padding

**Type:** number/list

The padding of the message inner element ...

The padding of the message inner element Defaults to: `0 5px`


### $loadmask-msg-padding

**Type:** number/list

The padding to apply to the LoadMask's message element ...

The padding to apply to the LoadMask's message element Defaults to: `2px`


### $loadmask-msg-text-padding

**Type:** number/list

The padding of the message element ...

The padding of the message element Defaults to: `5px 5px 5px 20px`
...
Opacity of the LoadMask Defaults to: `0.5`
