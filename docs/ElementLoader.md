...
Ext.get('el').load({ url: 'myPage.php', scripts: true, params: { id: 1 } }); In general this class will not be instanced directly, rather the Ext.Element.load method will be used.
...
True or a string to show when the element is loading. Defaults to: `false`
...
A custom function to render the content to the element. The function should return false if the renderer could not be applied. The passed parameters are: - The loader - The response - The active request
...
True to parse any inline script tags in the response. Defaults to: `false`
...
**Parameters:** target : String/HTMLElement/Ext.ElementThe element or its ID.
