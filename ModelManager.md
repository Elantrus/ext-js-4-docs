...
**Tipo:** Ext.data.association.Association[]
...
Returns the Ext.data.Model class for a given model name
Parametersid : String/ObjectThe classname of the model or the model class itself.
...
Parametersmodel : FunctionThe model that was just created
...
together
Parametersassociation : Ext.data.association.AssociationThe association
