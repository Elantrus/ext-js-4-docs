...
Realigns the editor to the bound field based on the current alignment config value.
ParametersautoSize : Boolean (optional)True to size the field to the dimensions of the bound element.
...
Sets the data value of the editor
Parametersvalue : ObjectAny valid value supported by the underlying field
...
Starts the editing process and shows the editor.
Parametersel : String/HTMLElement/Ext.ElementThe element to edit
